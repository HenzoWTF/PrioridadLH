...
fun ClienteRow(
    ...
    Card(
        onClick = {
            onClickCliente(it.clientesID ?: 0)
        },
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Nombre: ${it.nombresClientes}",
                ...
                Text(
                    text = "Email: ${it.emailClientes}",
                    style = MaterialTheme.typography.titleLarge
                )

                Text(
                    text = "Dirección: ${it.direccionClientes}",
                    style = MaterialTheme.typography.titleLarge
                )
            }
        }
